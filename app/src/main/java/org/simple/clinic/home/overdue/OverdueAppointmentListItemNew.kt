...
sealed class OverdueAppointmentListItemNew : ItemAdapter.Item<UiEvent> {
  ...
  companion object {
    ...
    fun from(
      ...
      val pendingToCallListItem = pendingToCallItem(overdueAppointmentSections, clock)
    ...
    private fun pendingToCallItem(overdueAppointmentSections: OverdueAppointmentSections, clock: UserClock): List<OverdueAppointmentListItemNew> {
